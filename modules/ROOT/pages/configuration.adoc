...
[NOTE]
====
Check link:https://central.sonatype.com/artifact/org.neo4j.connectors/commons-authn-keycloak[Maven Central] for the latest available version and use it in place of `LATEST_VERSION` below.
====
