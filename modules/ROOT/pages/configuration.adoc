...
Besides using spark options to control how the connector reads and writes to and from Neo4j, there are some extendend use cases.
Here in this page you can read about how to use the spark connector to manage mutliple connections and Neo4j driver options and more.
