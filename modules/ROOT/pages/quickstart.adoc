...
[shell]
----
$SPARK_HOME/bin/spark-shell --jars neo4j-connector-apache-spark_2.13-5.2.0_for_spark_3.jar
----
...
[shell]
----
$SPARK_HOME/bin/spark-shell --packages org.neo4j:neo4j-connector-apache-spark_2.13:5.2.0_for_spark_3
----
...
[shell]
----
scala spDependencies += "org.neo4j/neo4j-connector-apache-spark_${scala.version}:5.2.0_for_spark_${spark.version.major}"
----
...
[text]
----
libraryDependencies += "org.neo4j" % "neo4j-connector-apache-spark_${scala.version}" % "5.2.0_for_spark_${spark.version.major}"
----
...
<dependencies>
  ...
  <dependency>
    ...
    <version>5.2.0_for_spark_${spark.version.major}</version>
  </dependency>
</dependencies>
----
...
dependencies{
    // list of dependencies
    compile "org.neo4j:neo4j-connector-apache-spark_${scala.version}:5.2.0_for_spark_${spark.version.major}"
}
----
