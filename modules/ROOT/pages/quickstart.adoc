...
You can copy-paste and run the following examples directly in the xref:installation.adoc#_to_run_code_interactively[interactive Spark shell] (`spark-shell` for Scala, `pyspark` for Python).
...
To develop a standalone application, you need to install the Spark connector as explained in the xref:installation.adoc#_to_develop_applications[Installation] section.
