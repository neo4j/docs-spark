...
[cols="1,3,2,2"]
|===
| | Artifact ID | Version (Spark 3.0 and 3.1) | Version (Spark 3.2+)
...
You can include the connector in your application using a build tool, then use `spark-submit` to run the application.
...
[source, text]
----
include::example$python/requirements.txt[]
----
=====
