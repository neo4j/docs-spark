...
Have a look at the xref:compatibility.adoc[compatibility tables] to determine what connector version is suitable for your setup.
The examples below will demonstrate using the latest {connector-version} connector.
