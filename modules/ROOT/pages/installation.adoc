...
Below is a compact compatibility table to help you choose the correct version of the connector given your version of Spark.
Refer to xref:overview.adoc#_compatibility[this page] for full compatibility information.
