...
* Copy-paste the coordinates from the xref:installation.adoc#version[Installation] section (for example `org.neo4j:neo4j-connector-apache-spark_2.12:{exact-connector-version}_for_spark_3`).
