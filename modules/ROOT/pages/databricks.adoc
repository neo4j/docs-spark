...
The following example shows how to read a Delta table and write its data as nodes and relationships to Neo4j.
See the xref:writing.adoc#write-node[Writing] page for more details on how to write nodes only.
...
See the xref:writing.adoc#write-rel[Writing] page for more details on how to write relationships too.
