...
=== Read Delta tables and write to Neo4j
...
The following example shows how to read a Delta table and write its data as nodes and relationships in Neo4j.

[%collapsible]
.Content of the Delta table
====
The example assumes that a Delta table `customers_products_example` exists and contains the following data about customers and products:
...
=== Read from Neo4j and write to Delta tables

The following example shows how to read data from Neo4j and write it as a Delta table.
