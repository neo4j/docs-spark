...
The following table highlights the compatible versions between this connector, Neo4j and Spark.
...
Neo4j versions includes both community editions and enterprise editions.
All Neo4j Connector for Apache Spark versions of the 5.x family supports Scala version 2.12 and 2.13, with minimum required Java runtime version 8.
If your version is missing from the table, please refer to the xref:compatibility.adoc[End of Life versions] page.
