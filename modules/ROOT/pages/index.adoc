...
The following table overview the compatible versions between this connector, Neo4j, Spark and Databricks.
For a more detailed compatibility view, see the xref:compatibility.adoc[compatibility tables] page.
...
All Neo4j Connector for Apache Spark versions of the 5.x family supports Scala version 2.12 and 2.13.
Minimum required runtime of Java version 8.
