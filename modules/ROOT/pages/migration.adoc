...
[NOTE]
====
5.1.0 is the last release compatible with Spark 3.3.
To stay on Spark 3.3 going forward, pin the connector to 5.1.0 — see xref:installation.adoc#version[the compatibility table].
====
