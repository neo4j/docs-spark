...
[source, cypher]
----
MATCH (n:NON_EXISTENT_LABEL)
RETURN id(n) AS id, n.name, n.age
----
...
[TIP]
====
In Neo4j 3.x and Neo4j 4.0, the order of the returned columns is not guaranteed to match the `RETURN` statement.
