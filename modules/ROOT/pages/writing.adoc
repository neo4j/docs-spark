...
|`schema.optimization.node` |UNIQUE/KEY/NONE |NONE | Create the `UNIQUE` or `NODE KEY` constraint for the properties defined in the option `node.keys`
|`schema.optimization.relationship` |UNIQUE/KEY/NONE |false | Create the `UNIQUE` or `NODE KEY` constraint for the properties defined in the option `relationship.keys`
...
====== Using `schema.optimization.node`

**Enforcing unique constraint**

[NOTE]
For a detailed description of how Neo4j handles unique constraints on nodes please go to the official https://neo4j.com/docs/cypher-manual/current/constraints/#unique-node-property[documentation]
...
----
    ds.write
      ...
      .option("labels", ":Person:Customer")
      .option("node.keys", "surname")
      .option("schema.optimization.node", "UNIQUE")
      .save()
----
...
[NOTE]
For a detailed description of how Neo4j handles node key constraints please go to the official https://neo4j.com/docs/cypher-manual/current/constraints/#node-key[documentation]
...
====== Using `schema.optimization.relationship`

**Enforcing unique constraint**

[NOTE]
For a detailed description of how Neo4j handles unique constraints on relationships please go to the official https://neo4j.com/docs/cypher-manual/current/constraints/#unique-relationship-property[documentation]
...
[NOTE]
For a detailed description of how Neo4j handles relationship key constraint please go to the official https://neo4j.com/docs/cypher-manual/current/constraints/#relationship-key[documentation]
